...
while True:
    ...
    master = input("Enter your master password, or forget code if you forgot your password\n: ")
    if master != "":
            ...
            while True:
                ...
                if inp == "1":
                    ...
                    if mastered == mannered[0]:
                        ...
                        name = input("or press enter to go back to the main menu\n: ")
                        if name != "":
                            system("cls")
                        ...
                        if gen == "1":
                            ...
                            if mastered == mannered[0]:
                                ...
                                if len(dat) == 1:
                                    ...
                                    che = input("Enter the name of the account\n: ")
                                    che = che.upper()
                                    system("cls")
                                    if che not in dat:
                    ...
                    if mastered == mannered[0]:
                        system("cls")
                        iexp = input("Enter the account you would like to remove\n: ")
                        iexp = iexp.upper()
                        if iexp in dat:
                            del dat[iexp]
                    ...
                    if mastered == mannered[0]:
                        system("cls")
                        iexp = input("Enter the account you would like to change the password\n: ")
                        iexp = iexp.upper()
                        if iexp in dat:
                    ...
                    if enter == 1:
                        direct = input("Enter the directory to save the backup to\n: ")
                        ...
                        direct_in = input("Enter the full directory of the backup file\n: ")
